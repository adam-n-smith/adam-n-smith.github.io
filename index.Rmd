...
[Inference for Product Competition and Separable Demand](files/separabledemand.pdf) (2019) with Peter Rossi and Greg Allenby, *Marketing Science*, 38(4): 690-710 [[online appendix](files/separabledemand_appendix.pdf)]

[Demand Models with Random Partitions](files/dmrp.pdf) (2020) with Greg Allenby, *Journal of the American Statistical Association*, 115(529): 47-65 [[online appendix](files/dmrp_appendix.pdf)]
...
[Capturing Flexible Price Elasticities in Direct Utility Models](files/outsidegood.pdf) with Chul Kim, Jaehwan Kim, and Greg Allenby
...
- [Bayesian Linear Regression](files/bayesian_regression.pdf)
- [Cholesky Decomposition](files/cholesky_decomposition.pdf)
- [Gibbs Sampling](files/gibbs_sampling.pdf)
- [Monte Carlo Integration and Importance Sampling](files/mc_integration.pdf)
